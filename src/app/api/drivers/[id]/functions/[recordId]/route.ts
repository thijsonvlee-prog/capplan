...
export async function PUT(
  ...
  try {
    ...
    logAudit("DriverFunctionRecord", recordId, "UPDATE", null, { startDate: body.startDate, endDate: body.endDate, position: body.position, locationId: body.locationId, departmentId: body.departmentId, manager: body.manager }, userId);
...
export async function DELETE(
  ...
  try {
    ...
    const userId = await getAuditUserId();
    logAudit("DriverFunctionRecord", recordId, "DELETE", existing, null, userId);
