...
export function ScenarioSelector() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      {activeId !== "default" && (
        <span className="bg-warning-50 text-warning-700 px-2 py-0.5 rounded text-xs font-medium" title="Dit scenario is een werkkopie en heeft geen invloed op de actuele planning">
          Concept
        </span>
      )}
      ...
      {showCreate && (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50" role="dialog" aria-modal="true" aria-label="Nieuw scenario aanmaken" onKeyDown={(e) => { if (e.key === "Escape") setShowCreate(false); }}>
